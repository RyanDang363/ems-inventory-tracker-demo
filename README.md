...
One of the more unique features is the Google Forms integration. Field staff fill out a form, and it automatically updates inventory. Here's how I set it up:
...
The script sends form data to the backend API, which updates the database and records the transaction. 
...
This is a demo project just for proof of concept, so I kept some things simple:
